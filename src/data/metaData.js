...
export const metaTeamDatabase = {
  'S+': [
    ...
    },
    {
      ...
      niches: ["Dynamo", "FUA"],
      description:
        "Oriented around keeping [Electric Field] at high levels through [Dynamo]. This team combines Lucy's generally strong attributes like [Data Iteration] and [Pragmatist] with Ulrich's surprisingly personal output and various Channel effects to blend Incan and Ultimate Might buffs.",
    },
    {
      ...
      niches: ["Ultimate"],
      description:
        "The standard hypercarry Recoleta setup. Splits AP between Recoleta and Melania to upkeep [Passion Drain] and quickly stack [Fixed Plan] on all allies. Facilitated by Lopera who due to Recoleta's Ult cheating only needs to spend 1 AP per Array cycle.",
    },
  ],
  S: [
    {
      ...
      niches: ["FUA", "Crit"],
      description:
        "A Windsong composition focusing on short-cycle burst windows utilizing a swift rotation of FUAs from Windsong's Ultimate, Fatutu's 'Unmendable Cracks' casts and Lopera's channel to keep [Gust] stacked.",
    },
    {
      name: "Glug Glug 3000",
      ...
      niches: ["FUA"],
      description:
        "JNZ's high frequency of FUAs in her channel easily builds [Gust] and keeps [Shell Beacon] at a high uptime and her damage is further facilitated through [Adieu! Mother Earth], stacked [Spirit Shell] and +FUA DMG Dealt.",
    },
  ],
  cores: {
    "Voyager + Kiperina": {
...
export const synergyCoreDatabase = {
  "Mental Crit": {
    ...
    description:
      "A Mental damage core that leverages critical hits. Voyager provides crucial crit-rate buffs and control, setting up Regulus to deal high damage with her ultimate.",
  ...
  "Reality Burst": {
    ...
    description:
      "A Reality damage core focused on burst damage. An-an Lee provides significant buffs to Reality damage dealers, allowing A Knight to unleash powerful attacks.",
    bestWith: "A survival character like Sotheby or Ms. NewBabel, and another Reality sub-dps.",
  },
  "Poison Ivy": {
    characters: ["Jessica", "Sotheby"],
    description:
      "A damage-over-time core centered around Poison. Jessica is a potent poison applicator, while Sotheby's healing is enhanced when allies are debuffed, creating a unique synergy. Both deal Reality damage.",
  ...
  "FUA Fiesta": {
    ...
    description:
      "A Follow-up Attack (FUA) core. Jiu Niangzi is a strong FUA DPS, and Pickles provides valuable buffs that enhance overall team damage and consistency.",
  ...
  "Ultimate Spam": {
    ...
    description:
      "A core focused on rapidly charging and using ultimates. Kaalaa Baunaa is a DPS that benefits from frequent ultimate usage, and 6 is a unique support that can generate Moxie for the team.",
  ...
  "Beast Powerhouse (Mental)": {
    ...
    description:
      "A versatile and powerful Beast-afflatus Mental damage core. Melania (S+ Sub DPS) is a top-tier damage dealer who ramps up with her ultimate. Medicine Pocket (S Survival) provides excellent healing and a valuable damage amplification debuff. Their shared Beast afflatus makes them a strong pairing against Plant-type enemies.",
    bestWith: "A main Mental DPS like Barcarola or Willow, and a buffer like 6 or Voyager.",
  },
  "Genesis Damage": {
    characters: ["37", "6"],
    description:
      "A Mental damage core focused on the unique 'Genesis' damage type. 37 (A+ DPS) is the main damage dealer. 6 (A Support) provides a mix of buffs for the team and debuffs for the enemy, enhancing 37's damage while controlling the flow of battle.",
  ...
  "Reality Nuke": {
    ...
    description:
      "A Reality damage core designed for massive burst damage. An-an Lee (A Support) provides substantial buffs that dramatically increase the critical damage output of Lilya (A DPS), allowing her ultimate to one-shot powerful enemies.",
  ...
  "Plant Control": {
    ...
    description:
      "A Plant-afflatus Mental damage core. Noire (A DPS) serves as the main damage dealer, while Druvis III (A Sub DPS) provides excellent crowd control with her [Petrify] mechanic, locking down enemies.",
  ...
  "Burn & Debuff": {
    ...
    description:
      "A Reality damage core that focuses on the [Burn] DoT effect. Spathodea (A DPS) is the primary damage dealer. Shamane (B Support) provides crucial debuffs that amplify all damage taken by the enemy, significantly boosting Spathodea's output.",
    bestWith: "A strong survival character like Ms. NewBabel, and another Reality damage dealer or buffer like An-an Lee.",
  },
  "Poison System": {
    characters: ["Jessica", "Sotheby"],
    description:
      "A Reality damage core that revolves around the [Poison] status effect. Jessica (S DPS) is a powerful damage dealer whose effectiveness is amplified by [Poison]. Sotheby (S+ Survival) provides healing and additional [Poison] application, creating a feedback loop of damage and survivability.",
  ...
  "Follow-up Frenzy": {
    ...
    description:
      "A Reality damage core focused on maximizing follow-up attacks. Centurion (S+ DPS) deals significant damage through her follow-up mechanic. Pickles (A Support) provides buffs that enhance Centurion's damage output and can contribute his own damage.",
  ...
  "Mineral Shield Wall": {
    ...
    description:
      "A highly durable Reality damage core from the Mineral afflatus. Eternity (S Sub DPS) provides both damage and survivability through her [Nasty Wound] and self-healing. Ms. NewBabel (A+ Survival) offers strong shields and healing, making the team incredibly resilient.",
  ...
  "Spirit Control & Debuff": {
    ...
    description:
      "A Mental damage core that focuses on controlling the battlefield and debuffing enemies. Voyager (A Support) can inflict [Silence] and [Confusion], disrupting enemy actions. Tooth Fairy (S+ Survival) provides top-tier healing while applying [Weakness] to increase damage taken by enemies.",
  ...
  "Taunt & Counter": {
    ...
    description:
      "A Reality damage core built around a defensive 'Taunt' and 'Counter' strategy. A Knight (A Sub DPS) draws enemy fire with his [Taunt] and retaliates with powerful counters. Medicine Pocket (S Survival) ensures A Knight stays alive with their potent healing and provides a damage amplification debuff.",
  ...
  "Star Afflatus Synergy": {
    ...
    description:
      "A Star-afflatus Reality damage core. Regulus (S+ DPS) and Lilya (A DPS) are both powerful damage dealers who benefit from their shared afflatus when facing Intellect-type enemies. Regulus provides consistent damage and some utility, while Lilya offers massive burst damage with her ultimate.",
  ...
  "Intellect Afflatus Synergy": {
    ...
    description:
      "An Intellect-afflatus Reality damage core. Centurion (S+ DPS) is a top-tier damage dealer who can take advantage of the buffs provided by An-an Lee (A Support), who is also of the Intellect afflatus. This pairing is particularly effective against Beast-type enemies.",
